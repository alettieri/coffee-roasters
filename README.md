...
Install the Chromium browser once per machine before running Playwright:
...
| `PRODUCTION_SMOKE_PUBLIC_DISCOVERY_URL` | Actions variable | Public Roaster Discovery smoke-test URL with no private data. |
